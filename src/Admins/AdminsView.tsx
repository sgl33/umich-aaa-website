        ...
        <div id="admin" className="view-section-container">
            <div className="view-content-container">
                ...
                <div className={isMobile ? "admins-view-content-mobile" : "admins-view-content-desktop"}>
                    <AdminItem name="Stekuns" role="President" pfp={placeholderImg}/>
                    <AdminItem name="Fern" role="Vice President" pfp={placeholderImg}/>
                    ...
                    <AdminItem name="Luca" role="Social Chair" pfp={placeholderImg}/>
                </div>
